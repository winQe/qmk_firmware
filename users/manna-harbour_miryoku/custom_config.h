...
KC_EXLM,           KC_MINS,           KC_PLUS,            KC_EQL,           KC_HASH,           U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
U_NU,              KC_SLSH,           KC_ASTR,           KC_CIRC,           KC_QUES,           U_NA,              TD(U_TD_U_SYM),    TD(U_TD_U_MOUSE),  KC_ALGR,           U_NA,              \
...
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              KC_PIPE,           KC_COLN,           KC_LPRN,           KC_RPRN,           KC_SCLN,             \
